...
if len(web_requests.cache) < 10:
    ...
    vuzes_links = {
        ...
        "ИТМО": itmo.discover_links(
            "01.03.02 09.03.01 09.03.02 09.03.03 09.03.04 10.05.01 38.03.05 02.03.01 02.03.02".split()),
    }
    print('Ready')
    ...
    vuzes_links = {
        ...
        "ИТМО": itmo.discover_links(
            "01.03.02 09.03.01 09.03.02 09.03.03 09.03.04 10.05.01 38.03.05 02.03.01 02.03.02".split(), offline=True),
    }
